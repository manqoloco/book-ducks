...
let addLoggedInCells = (books,profiles) => {
  ...
  books.forEach((book, index) => {    
    ...
    // adds option for choosing score
    ...
    //disables buttons if clicked on
    ...
    // sets score to chosen book, adds reading list to profile
...
// gets all book attributes from cms
...
// gets token from the user that's logged in
...
// when logged out the token and loginId are removed and so is everything in myList
let logout = () => {
...
// uppdates the books average score after applying my rating
